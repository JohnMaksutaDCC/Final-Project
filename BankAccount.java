 ...
 * BankAccount.java
 * 
 * Modification of an example in Cay Horstmann's "Computing Concepts with Java 2
 * Essentials".
 *
...
public class BankAccount {
	 ...
	 * 
	 * @param initialAmount
	 *            the initial amount in the account when it is created
	 */
	...
	/**
	 * Withdraws from the bank account. Limitation: Does not test for an
	 * overdrawn account.
	 * 
	 * @param amount
	 ...
	 * 
	 * @param other
	 *            the bank account to transfer money to
	 * @param amount
